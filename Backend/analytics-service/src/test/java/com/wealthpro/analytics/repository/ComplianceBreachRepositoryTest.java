...
class ComplianceBreachRepositoryTest {
    ...
    void setUp() {
        ...
        breach1 = ComplianceBreach.builder()
                .accountId(1001L).ruleViolated("MAX_SINGLE_STOCK_EXPOSURE")
        ...
        breach2 = ComplianceBreach.builder()
                .accountId(1001L).ruleViolated("CASH_RESERVE_MINIMUM")
        ...
        breach3 = ComplianceBreach.builder()
                .accountId(2002L).ruleViolated("SECTOR_CONCENTRATION_LIMIT")
    ...
    void testSave_positive() {
        ComplianceBreach newBreach = ComplianceBreach.builder()
                .accountId(3003L).ruleViolated("LEVERAGE_LIMIT")
    ...
    void testSave_nullRequiredField_exception() {
        ComplianceBreach invalidBreach = ComplianceBreach.builder()
                .accountId(1001L).ruleViolated(null)  // nullable = false
    ...
    void testFindById_positive() {
        ...
        assertEquals("MAX_SINGLE_STOCK_EXPOSURE", found.get().getRuleViolated());
    }
    ...
    void testFindByAccountId_singleResult_positive() {
        ...
        assertEquals("SECTOR_CONCENTRATION_LIMIT", breaches.get(0).getRuleViolated());
    }
    ...
    void testFindByAccountIdAndStatus_positive() {
        ...
        assertEquals(1, breaches.size());
        assertEquals("MAX_SINGLE_STOCK_EXPOSURE", breaches.get(0).getRuleViolated());
    }
    ...
    void testFindByAccountIdAndStatus_acknowledged_positive() {
        ...
        assertEquals(1, breaches.size());
        assertEquals("CASH_RESERVE_MINIMUM", breaches.get(0).getRuleViolated());
    }
