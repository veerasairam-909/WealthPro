...
public class SecurityServiceImpl implements SecurityService {
    ...
    public SecurityResponse createSecurity(SecurityRequest request) {
        if (securityRepository.existsBySymbol(request.getSymbol())) {
    ...
    public SecurityResponse updateSecurity(Long securityId, SecurityRequest request) {
        ...
        if (!existing.getSymbol().equals(request.getSymbol())
                && securityRepository.existsBySymbol(request.getSymbol())) {
            throw new DuplicateResourceException(
