...
public class StatementControllerImpl implements StatementController {
    ...
    public ResponseEntity<StatementResponse> getStatementById(@PathVariable Long statementId) {
    ...
    public ResponseEntity<List<StatementResponse>> getStatementsByAccountId(@PathVariable Long accountId) {
    ...
    public ResponseEntity<StatementResponse> updateStatement(@PathVariable Long statementId,
