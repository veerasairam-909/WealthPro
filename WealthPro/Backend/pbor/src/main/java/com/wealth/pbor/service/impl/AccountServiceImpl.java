...
public class AccountServiceImpl implements AccountService {
    ...
    @Override
    public List<AccountResponse> getAccountsByClientIdAndStatus(Long clientId, AccountStatus status) {
        List<Account> accounts = accountRepository.findByClientIdAndStatus(clientId, status);
        List<AccountResponse> responseList = new ArrayList<>();
        for (Account account : accounts) {
            responseList.add(mapper.map(account, AccountResponse.class));
        }
