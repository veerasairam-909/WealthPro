...
public class GlobalExceptionHandler {
    ...
    /**
     * Preserves the HTTP status on ResponseStatusException (e.g. 403 from OwnershipGuard).
     * Without this, the catch-all below would downgrade every ResponseStatusException to 500.
     *
     * @param ex the ResponseStatusException
     * @return the original status with the original reason
     */
