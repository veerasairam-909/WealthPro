...
public interface RecommendationController {
    ...
    ResponseEntity<RecommendationResponse> createRecommendation(RecommendationRequest request, String roles, Long authClientId);

    @Operation(summary = "Get all recommendations",
            description = "Retrieves all recommendations across all clients.")
    ResponseEntity<List<RecommendationResponse>> getAllRecommendations(String roles, Long authClientId);
    ...
    ResponseEntity<RecommendationResponse> getRecommendationById(
            ...
            String roles, Long authClientId);
