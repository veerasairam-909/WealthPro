...
public interface GoalController {
    ...
    ResponseEntity<GoalResponse> createGoal(GoalRequest request, String roles, Long authClientId);
    ...
    ResponseEntity<List<GoalResponse>> getAllGoals(String roles, Long authClientId);
